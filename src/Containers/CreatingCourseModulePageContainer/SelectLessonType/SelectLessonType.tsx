...
const SelectLessonTypeContainer = () => {
  //   Router
  ...
  const DeliverLearningContent = [
    {
      ...
      detail:
        'Engage your students with video content to enhance their learning experience',
      icon: (
        <svg
          width="32"
          height="32"
        ...
        >
          <path
            d="M19.6692 14.8906L15.4063 12.0486C14.5202 11.4579 13.3333 12.0931 13.3333 13.158V18.842C13.3333 19.9069 14.5202 20.5421 15.4063 19.9514L19.6692 17.1094C20.4609 16.5816 20.4609 15.4184 19.6692 14.8906Z"
            stroke="#2E2E2E"
            stroke-width="2"
    ...
    },
    {
      title: 'Customize',
      detail:
        'Tailor your lessons with custom content to suit your unique teaching style and objectives.',
      icon: (
        <svg
          width="32"
          height="32"
    ...
    },
    {
      title: 'Presentation',
      detail:
        'Use Google slides or PowerPoint to deliver engaging presentations to convey information effectively.',
      icon: (
        <svg
          width="32"
          height="32"
  ...
  const AssessmentTools = [
    {
      title: 'Quiz',
      detail:
        "Test students' understanding of essential concepts with interactive quizzes.",
      icon: (
        <svg
          width="32"
          height="32"
    ...
    },
    {
      ...
      detail:
        'Assign hands-on tasks and projects to put knowledge and skills into practice.',
      icon: (
        <svg
          width="32"
          height="32"
    ...
    },
    {
      title: 'Final exam',
      detail:
        'Evaluate overall course comprehension with a comprehensive final exam.',
      icon: (
        <svg
          width="32"
          height="32"
          ...
          {DeliverLearningContent.map((data, i) => {
            return (
              <CourseTypeItem
                ...
                onClick={() => {
                  navigate(
                    `/courses/${courseId}/${curriculumId}/${moduleId}/${weekId}/${data.title
                      .replaceAll(' ', '-')
                      .toLowerCase()}`
                  )
                }}
...
export default SelectLessonTypeContainer
