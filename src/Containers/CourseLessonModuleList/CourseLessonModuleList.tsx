        ...
        {modules.map((data, i) => {
          return (
            <div>
              ...
              >
                ...
                <div className={classes.moduleTitleContainer}>
                  ...
                  <div className={classes.moduleTitleCourseContent}>
                    {moduleCourseFileType.map((file, index) => (
                      <div key={index}>
                        <p>{file.title}</p>
                        {file.svg}
                      </div>
              ...
              <div
                className={`${classes.module} {classes.weekContainer} ${data.active ? classes.active : undefined
                  }`}
                key={i}
                style={
                ...
                <div className={classes.moduleTitleContainer}>
                  ...
                  >
                    ...
                    {data.weeks.map((datum: any, j: number) => {
                      return <span key={j}>{datum.subTitle}</span>
                    })}
                  </p>
                </div>
                <div>
                  {data.weeks[0].videos.map((datum: any, k: number) => {
                    return (
                      <div key={k} className={classes.week}>
                        <div className={classes.courseFile}>
                          <p>{datum.title}</p>
                          <p>
                            <span>{datum.type}</span> .
                            <span>{datum.duration}</span>
                          </p>
                        </div>
