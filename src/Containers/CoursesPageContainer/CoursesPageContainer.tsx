                                ...
                                <div className={classes.reviewCardFooter}>
                                    ...
                                    <p>
                                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M8.33274 5.66667H11.5087C12.4999 5.66667 13.1445 6.70975 12.7013 7.59629L10.3679 12.263C10.1421 12.7147 9.68039 13 9.17536 13H6.49688C6.38787 13 6.27926 12.9866 6.1735 12.9602L3.66608 12.3333M8.33274 5.66667V2.33333C8.33274 1.59695 7.73579 1 6.99941 1H6.93576C6.60272 1 6.33274 1.26998 6.33274 1.60302C6.33274 2.07922 6.19179 2.54477 5.92764 2.94099L3.66608 6.33333V12.3333M8.33274 5.66667H6.99941M3.66608 12.3333H2.33274C1.59636 12.3333 0.999408 11.7364 0.999408 11V7C0.999408 6.26362 1.59636 5.66667 2.33274 5.66667H3.99941" stroke="#2E2E2E" strokeWidth="1.5" stroke-linecap="round" />
                                        </svg>
                                        <span>{data.likeTotal}</span>
                                    </p>
                                    <p>
                                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M4.33333 6.99984H4.34M7 6.99984H7.00667M9.66667 6.99984H9.67333M13 6.99984C13 9.94536 10.3137 12.3332 7 12.3332C5.97382 12.3332 5.00781 12.1042 4.16311 11.7005L1 12.3332L1.92999 9.85319C1.34104 9.02807 1 8.04935 1 6.99984C1 4.05432 3.68629 1.6665 7 1.6665C10.3137 1.6665 13 4.05432 13 6.99984Z" stroke="#2E2E2E" strokeWidth="1.5" stroke-linecap="round" />
                                        </svg>
