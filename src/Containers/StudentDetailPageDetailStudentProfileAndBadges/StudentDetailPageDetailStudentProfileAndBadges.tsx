...
type StudentDetailPageDetailStudentProfileAndBadgesType = {
  student: any
}

const StudentDetailPageDetailStudentProfileAndBadges = ({
  student,
}: StudentDetailPageDetailStudentProfileAndBadgesType) => {
  //   // Utils
  //   const badges = [
  //     {
      ...
      >
        <div className={classes.userDetails}>
          <div className={classes.userInfo}>
            <img src={student?.profile_image || noProfileImage} alt="User" />
            <div>
        ...
        >
          <div className={classes.userDetails}>
            <div className={classes.badgeSection}>
              {student?.badges?.map((data: any, i: number) => {
                return (
