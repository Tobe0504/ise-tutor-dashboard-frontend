...
const StarRating = ({ totalStars, initialRating = 0, width = 14, height = 13, editable = true }: StarRatingProps) => {
            ...
            {[...Array(totalStars)].map((_, index) => (
                <span
                    ...
                    style={{
                        ...
                        margin: '3px',
                        color: index < rating ? '#F2B414' : 'gray',
                    }}
                >
                    <svg
                        width={width}
