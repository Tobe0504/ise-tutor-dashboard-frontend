...
export const studentsData = [
   {
      ...
      about: 'Future entrepreneur with a passion for business and innovation. Always looking for opportunities to learn and create.',
   ...
   },
   {
      ...
      about: 'Art enthusiast exploring the world of digital art and design. Striving to bring creativity and imagination to life through visual storytelling.',
      country: 'Kenya',
   ...
   },
   {
      ...
      about: 'Advocate for social justice and equality. Committed to making a positive impact in the community through activism and awareness.',
      country: 'Nigeria',
      schoolLevel: 'Undergraduate',
   ...
   },
   {
      ...
      about: 'Sports enthusiast with a love for soccer. Whether playing or watching, the passion for the game is always at the forefront.',
      country: 'Ghana',
      schoolLevel: 'Postgraduate',
   ...
   },
   {
      ...
      about: 'Science and technology enthusiast. Eager to explore the frontiers of knowledge and contribute to advancements in the field.',
      country: 'South Africa',
      schoolLevel: 'Undergraduate',
   ...
   },
   {
      ...
      about: 'Tech enthusiast with a focus on artificial intelligence. Constantly exploring ways to apply AI to solve real-world problems.',
   ...
   },
   {
      ...
      about: 'Passionate about data science and analytics. Aspiring to make data-driven decisions and uncover meaningful insights.',
   ...
   },
   {
      ...
      about: 'Entrepreneurial spirit with a focus on startups and innovation. Dedicated to creating positive change through business ventures.',
      country: 'India',
      schoolLevel: 'Undergraduate',
   ...
   },
   {
      ...
      about: 'Passionate about sustainable energy and environmental conservation. Striving to make a positive impact on the planet.',
      country: 'Brazil',
      schoolLevel: 'Postgraduate',
   ...
   },
   {
      ...
      about: 'Aspiring UX/UI designer with a passion for creating user-centric and visually appealing digital experiences.',
      country: 'South Korea',
      schoolLevel: 'Undergraduate',
   ...
   },
   {
      ...
      about: 'Sports enthusiast and fitness advocate. Believes in maintaining a healthy lifestyle and inspiring others to do the same.',
      country: 'Australia',
      schoolLevel: 'Postgraduate',
